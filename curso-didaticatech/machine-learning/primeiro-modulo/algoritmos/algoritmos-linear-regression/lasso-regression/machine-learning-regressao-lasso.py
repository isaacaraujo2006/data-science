...
# Para encontrar a documentação de uma função: sklearn lasso
...
arquivo = pd.read_csv('D:/Ti/Cursos/Vscode/github/machine-learning/algoritmos/algoritmos-linear-regression/lasso-regression/kc_house_data.csv')
